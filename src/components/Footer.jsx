...
function Footer() {
  return (
    <footer className="w-[95%] m-auto mt-10 p-6 bg-gradient-to-r from-blue-400 to-blue-500 rounded-xl text-white font-sans text-xl font-semibold text-center flex items-center justify-center shadow-lg shadow-blue-300">
